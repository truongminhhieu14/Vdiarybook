...
export default function UpdatePostModal({ open, onClose, post, postedOn }: UpdatePostModalProps) {
  ...
  const [privacy, setPrivacy] = useState<"public" | "friends" | "private">(post.privacy || "public");
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div ref={modalRef} className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] p-4 relative overflow-hidden flex flex-col">
